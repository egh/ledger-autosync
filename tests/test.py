...
class TestFormatter(TestCase):
    def test_checking(self):
        ...
        formatter = ledgerautosync.formatter.Formatter(acctid=ofx.account.account_id, currency=ofx.account.statement.currency, name="Foo")
